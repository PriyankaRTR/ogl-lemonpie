...
TerrainShader::TerrainShader(const char* VERTEX_FILE, const char* FRAGMENT_FILE) : Shader(VERTEX_FILE, FRAGMENT_FILE)
{
...
void TerrainShader::loadSampler(GLuint sampler)
{
