...
mat4 gPerspectiveProjectionMatrix2;
...
void initialize(void)
{
	...
	gPerspectiveProjectionMatrix2 = mat4::identity();
...
void display(void)
{
	...
	glViewport(0.0, 0, (GLsizei)WIN_WIDTH / 2.0, (GLsizei)WIN_HEIGHT);
	...
	//glUniformMatrix4fv(gMVPUniform, 1, GL_FALSE, modelViewProjectionMatrix2);
	// *** bind vao ***
	glBindVertexArray(gVao);
	...
	glUseProgram(gShaderProgramObject);
	mat4 modelViewMatrix2 = mat4::identity();
	mat4 modelViewProjectionMatrix2 = mat4::identity();
	glViewport((GLsizei)WIN_WIDTH / 2.0, 0, (GLsizei)WIN_WIDTH / 2.0, (GLsizei)WIN_HEIGHT);

	modelViewMatrix2 = translate(0.0f, 0.0f, -6.0f);

	modelViewProjectionMatrix2 = gPerspectiveProjectionMatrix2 * modelViewMatrix2;
...
void resize(int width, int height)
{
	...
	if (height == 0)
		height = 1;
	glViewport(0, 0, (GLsizei)width/2.0, (GLsizei)height);
	...
	gPerspectiveProjectionMatrix2 = perspective(45.0, (GLfloat)width / (GLfloat)height, 1.0f, 100.0f);
}
